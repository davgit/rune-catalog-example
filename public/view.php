...
<html>
    <head>
        ...
        <link rel="stylesheet" href="codemirror/rune.css">
        <script src="codemirror/rune.js"></script>
        <!-- Some custom CSS -->
        <style type="text/css">
            ...
            <form action="#results" method="post">
                ...
                <div class="row">
                    <div class="text-center">
                        ...
                        <a class="btn btn-link" href="javascript:location.reload(true);">Reset Changes</a>
                    </div>
                </div>
                &nbsp;
            </form>
